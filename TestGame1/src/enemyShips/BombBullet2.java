/* This is the class for bomb bullets. It is a object on screen that at a certain time, or if it touches the player, explodes and creates 12 normal bullets
...
public class BombBullet2 extends GameObject{
	 ...
	 */
	public BombBullet2(float x, float y, ObjectID id, Handler handler, float angle, float vel, int timer) {
		super(x, y, id);	
	...
	private int explodeRecursive(int angle) {
		if (angle >= 360) {
			...
			return explodeRecursive(angle + 20);
		}
	}
